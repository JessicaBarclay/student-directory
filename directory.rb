...
def print_menu_options
  ...
  puts "3. Save the list to students.csv", "4. Load the list from students.csv"
  puts "9. Exit"
end
...
def print_header
  puts "The Students of Villains Academy".center(50), "_"*50
end
...
def print_footer
  if @students.count == 0 ; return
    ...
    puts "\nWe have a great student".center(50), "_"*50
  else
    puts "\nWe have #{@students.count} great students".center(50), "_"*50
  end
end
def save_students
